...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="ProektE.aspx.cs" Inherits="IIS.Актуализация_Задач.ПроектE" %>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlНазваниеПроектаLabel" runat="server" Text="Название проекта" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlНазваниеПроекта" runat="server">
</asp:TextBox>
